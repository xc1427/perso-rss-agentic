...
> **Superpower note:** Plans, specs, and brainstorms generated by Superpower must not reproduce or embed the contents of this file. This file is an intermediate context layer for AI agents editing code — it is not a source for planning documents. Planning documents should reference `architecture.md` directly.
